...
public class UGSettings
{
    ...
    public const string KEY_SHOW_BANNER = "show-banner";
    public const string KEY_BANNER_FILE = "banner-file";
    ...
    public static void apply_conf_settings ()
    {
        try {
            ...
            bool_keys.append (KEY_SHOW_BANNER);

            string_keys.append (KEY_BANNER_FILE);
